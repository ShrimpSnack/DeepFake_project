    ...
    try:
        while True:
            ...
            if len(faces) > 0:
                ...
                cv2.rectangle(canvas, (170, 100), (287,130), (255, 255, 255), -1)
                cv2.putText(canvas, "Now Feeling", (170,98 ), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255, 255, 255), 1)
                cv2.putText(canvas, label, (200, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
            # =============Emotion end==================
